...
# Required for agno to work with Google Gemini
        ...
        for idx, flight in enumerate(cheapest_flights):
            with cols[idx]:
                ...
                if departure_token:
                    ...
                    # Debug: Optional print to see structure
                    # print(json.dumps(results_with_booking, indent=2))

                    if 'best_flights' in results_with_booking:
                        try:
